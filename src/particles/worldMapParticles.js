...
module.exports = function worldMap() {
    ...
    function accelerate(opt) {
        ...
        opt.textList = "Marty: Keyboard, Juan: Drums, Thomas: Chello, Ferenc: Bass, Nicholas: Guitar, Mary: Violin";
        ...
        options.particleSize = opt.particleSize || 1; // number: particle size, default=0 (not shown)
        options.textColor = opt.textColor || "#dddddd"; // string
        // options.textList = (opt.textList || "Marty: Keyboard, Juan: Drums, Thomas: Chello, Ferenc: Bass, Nicholas: Guitar, Mary: Violin").split(', '); // string: list of strings separated with a comma and a space
        ...
        options.textList = opt.textList.split(', ');
    ...
    function reset(opt) {
        ...
        // let numberOfParticles = opt.textList.length || 0; // was problem, put || 0
        let numberOfParticles = opt.textList;
